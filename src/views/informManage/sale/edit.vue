		...
		<el-form :model="organForm" :rules="rules" ref="organForm" label-width="100px">
			<el-row>
				...
				<el-form-item label="详细说明" prop="desc">
					<el-input style="width: 81.81%;" type="textarea" v-model="organForm.desc" placeholder='请输入详细说明'></el-input>
				</el-form-item>
				</el-col>
				</div>
				<el-col :span="24">
				<div class="info-container" style="margin-top: 16px;">
					<span style="background-color: darkred;display: inline-block;width: 5px;height: 20px;"></span>
					<span style="margin-left: 10px;display: inherit;margin-top: -22px;">您的联系方式</span>
				</div>
				</el-col>
				<div style="background-color: #F2F6FC;width: 900px;height: auto;display: inline-block;padding-top: 25px;">
				<el-col :span="10">

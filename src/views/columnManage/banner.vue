<template>
	<div class="app-container">
		...
		<!-- 表格 -->
		<el-table :data="list" fit stripe highlight-current-row style="width: 100%;">
			<el-table-column label="序号" prop="key" align="center" width="55">
			</el-table-column>
			<el-table-column label="banner名称" prop="bannername" align="center">
			</el-table-column>
			<el-table-column label="位置描述" prop="locationdescribe" align="center">
			</el-table-column>
			<el-table-column label="轮播间隔时间（秒）" prop="banners" align="center" width="160">
			</el-table-column>
				...
				<template slot-scope="scope">
					<el-dropdown>
						...
						<el-dropdown-menu slot="dropdown">
							...
							<el-dropdown-item>
								<span @click="viewCardList(scope.row)">设置</span>
							</el-dropdown-item>
							<el-dropdown-item>

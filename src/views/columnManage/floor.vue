<template>
	<div class="app-container">
		...
		<el-table :data="list" fit highlight-current-row style="width: 100%;">
			<el-table-column label="楼层名称" prop="columnname" align="center">
			</el-table-column>
			<el-table-column label="楼层描述" prop="columndescribe" align="center" width="270">
			</el-table-column>
			<el-table-column label="楼层图片" prop="columnimg" align="center">
